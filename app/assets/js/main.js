...

 {
    ...
    "lectures":
    [
     {"class1": "topic", "Paperwork"},
     {"class2": "topic", "JavaScript Basics"},
     {"class3": "topic", "Array Methods, Functions & Scope/Hoisting"},
     {"class4": "topic", "OOP in JavaScript and Classes/Inheritance"},
     {"class5": "topic", "JavaScript in the Browser & Intro to jQuery"},
     {"class6": "topic", "Building a Server & Using Ajax"},
     {"class7": "topic", "Build & Deploy an App"},
     {"class8": "topic", "Functional Programming with lodash"}
    ]

    "Labs":
    [
      {"lab1": "topic", "lab1-beg-track"},
      {"lab2": "topic", "lab2-pdx-beg"},
      {"lab3": "topic", "lab3"}
    ]
}
